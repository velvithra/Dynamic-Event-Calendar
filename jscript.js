...
let nav=0;
let clicked=null;
const monthcal=document.querySelector("#month");
...
monthcal.innerText=`${dt.toLocaleDateString("en-us",
{
    month:"long",
})} ${year}`;
...
console.log(firstDayofMonth,dayInMonth);
...
if(i > emptyDays){
   ...
   const holiDay=holidays.find((e)=>e.hdate==dateText);
